...
sc = LoadXenium("datasets/S196572", fov="fov", segmentations="cell")

sc$orig.ident = "brain"
Idents(sc) = "brain"

# Load also nucleus_area and cell_area from cells.csv.gz
cells_metadata = read.csv("datasets/S196572/cells.csv.gz")
...
ref <- RunPCA(ref, features = VariableFeatures(ref), npcs = 50, nfeatures.print=5)
#reduction.name="pca.sketch", features=VariableFeatures(sc), npcs=50, nfeatures.print=5
