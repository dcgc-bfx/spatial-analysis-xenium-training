...
Run this chunk by clicking on the play symbol (top-right button) of the chunk. The output is shown below and can be anything: text, numbers, plots, etc. You can also run all chunks above this chunk by clicking on the button next to the play symbol.
...
A detailed documentation of the Markdown syntax can be found in the [quarto documentation](https://quarto.org/docs/guide/).

## Some comments on our workbook code
